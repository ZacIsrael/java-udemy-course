...
// Singleton patton is used when we want an application to create any one instance of a particular class
...
//            COLUMN_SONG_TITLE + " = ?";
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                try{
                    Thread.sleep(20); // thread sleeps for 20 milliseconds between each artist
    ...
    public List<Album> queryAlbumsForArtistId(int id){
        try{
            ...
            while(results.next()){
                ...
                album.setId(results.getInt(1)); // album id is in column 1
                album.setName(results.getString(2)); // album name is in column 2
