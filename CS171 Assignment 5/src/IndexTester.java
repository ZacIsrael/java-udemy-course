...
public class IndexTester {
    ...
    //        prefix = prefix.substring(0, prefix.length()-1); // Takes off the "*"
//        Stack<Node> allNodes = new Stack<Node>();
//        Node currentNode = t;
//        while(!allNodes.isEmpty() || currentNode != null){
//            if(currentNode != null){
//                allNodes.push(currentNode);
//                currentNode = currentNode.left;
//            } else{
//                Node myNode = allNodes.pop();
//                //System.out.println("Prefix:  " + prefix + ", ... Checking node with title:  " + myNode.data.shortTitle);
//
//                if(myNode.data.shortTitle.startsWith(prefix)){
//                    System.out.println(myNode.data.fullTitle);
//                }
//                currentNode = myNode.right;
//            }
//        }
}
